...
class FixationFilter():
    ...
    def selection(self, method = 'average'):
        if method == 'average' or method == 'strict_average':
            self.gaze_point_x = (self.left_gaze_point_3dx + self.right_gaze_point_3dx) / 2
            self.gaze_point_y = (self.left_gaze_point_3dy + self.right_gaze_point_3dy) / 2
            self.gaze_point_z = (self.left_gaze_point_3dz + self.right_gaze_point_3dz) / 2
            self.eye_position_x = (self.left_eye_position_3dx + self.right_eye_position_3dx) / 2
            self.eye_position_y = (self.left_eye_position_3dy + self.right_eye_position_3dy) / 2
            self.eye_position_z = (self.left_eye_position_3dz + self.right_eye_position_3dz) / 2

            self.normalized_x = (self.left_normalized_x + self.right_normalized_x) / 2
            self.normalized_y = (self.left_normalized_y + self.right_normalized_y) / 2

            self.pixels_x = (self.left_pixels_x + self.right_pixels_x) / 2
            self.pixels_y = (self.left_pixels_y + self.right_pixels_y) / 2
